...
#include "TetriTest/TetriTestProjectile.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeTetriTestProjectile() {}
...
// End Cross Module References
	...
	void ATetriTestProjectile::StaticRegisterNativesATetriTestProjectile()
	{
		UClass* Class = ATetriTestProjectile::StaticClass();
		static const FNameNativePtrPair Funcs[] = {
			{ "OnHit", &ATetriTestProjectile::execOnHit },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_ATetriTestProjectile_OnHit_Statics
	{
		struct TetriTestProjectile_eventOnHit_Parms
		{
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ATetriTestProjectile_OnHit_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ATetriTestProjectile, nullptr, "OnHit", nullptr, nullptr, sizeof(TetriTestProjectile_eventOnHit_Parms), Z_Construct_UFunction_ATetriTestProjectile_OnHit_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ATetriTestProjectile_OnHit_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00C20401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ATetriTestProjectile_OnHit_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ATetriTestProjectile_OnHit_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ATetriTestProjectile_OnHit()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_ATetriTestProjectile_OnHit_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	UClass* Z_Construct_UClass_ATetriTestProjectile_NoRegister()
	{
		return ATetriTestProjectile::StaticClass();
	}
	struct Z_Construct_UClass_ATetriTestProjectile_Statics
	{
	...
	UObject* (*const Z_Construct_UClass_ATetriTestProjectile_Statics::DependentSingletons[])() = {
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATetriTestProjectile_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "TetriTestProjectile.h" },
		{ "ModuleRelativePath", "TetriTestProjectile.h" },
	};
#endif
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ATetriTestProjectile_Statics::ClassParams = {
		&ATetriTestProjectile::StaticClass,
		"Game",
		&StaticCppClassTypeInfo,
		DependentSingletons,
		FuncInfo,
		Z_Construct_UClass_ATetriTestProjectile_Statics::PropPointers,
		nullptr,
		UE_ARRAY_COUNT(DependentSingletons),
		UE_ARRAY_COUNT(FuncInfo),
		UE_ARRAY_COUNT(Z_Construct_UClass_ATetriTestProjectile_Statics::PropPointers),
		0,
		0x008000A4u,
		METADATA_PARAMS(Z_Construct_UClass_ATetriTestProjectile_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_ATetriTestProjectile_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_ATetriTestProjectile()
	{
		static UClass* OuterClass = nullptr;
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_ATetriTestProjectile_Statics::ClassParams);
		}
		return OuterClass;
	}
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_ATetriTestProjectile(Z_Construct_UClass_ATetriTestProjectile, &ATetriTestProjectile::StaticClass, TEXT("/Script/TetriTest"), TEXT("ATetriTestProjectile"), false, nullptr, nullptr, nullptr);
	DEFINE_VTABLE_PTR_HELPER_CTOR(ATetriTestProjectile);
